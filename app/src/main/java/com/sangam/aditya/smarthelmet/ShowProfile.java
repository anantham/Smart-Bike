...
public class ShowProfile extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView medicalHistory = (TextView)findViewById(R.id.textViewmedicalhistory);

        SharedPreferences pref = getApplicationContext().getSharedPreferences(Home.USER, MODE_PRIVATE);

        name.setText(pref.getString(Home.USER_NUMBER_NAME,"Not registered")+" ("+pref.getString(Home.USER_GENDER,"")+")");
        ...
        medicalHistory.setText(pref.getString(Home.USER_MEDICAL_HISTORY,"Not registered"));
